...
/*
extern "C" AIUResultCode
AIUGetTensorType(AIUContext, int64_t dim_cnt, int64_t dims[], AIUType elemType, AIUType *result);
*/
...
/*  - kernel func params */
extern "C" AIUResultCode
AIUAddParameter(AIUModel func, AIUType type, AIUValue *result);
...
/*  - add constant */
extern "C" AIUResultCode
AIUAddConstant(AIUModel func, AIUType resType, void *value,
               AIUValue *result);

/*  - add constant */
extern "C" AIUResultCode
AIUAddConstantSplat(AIUModel func, AIUType resType, void *value,
                    AIUValue *result);

/*  - add operation */
extern "C" AIUResultCode
AIUAddOperation(AIUModel func, AIUOperationEnum type,
...
/*  - set return value */
extern "C" AIUResultCode
AIUSetReturn(AIUModel func, AIUValue retVals);
